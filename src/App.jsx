...
function PrivateRoute({ children }) {
  ...
  if (loading) return <div style={{display:'flex',alignItems:'center',justifyContent:'center',height:'100vh',fontFamily:'Plus Jakarta Sans,sans-serif',color:'#64748B'}}>Chargement...</div>
